...
hi VertSplit ctermfg=231 ctermbg=59 cterm=NONE guifg=#575e61 guibg=#252c31 gui=NONE
hi MatchParen ctermfg=180 ctermbg=NONE cterm=underline guifg=#dda790 guibg=NONE gui=underline
hi StatusLine ctermfg=231 ctermbg=59 cterm=bold guifg=#f0f0f0 guibg=#8bb664 gui=NONE
...
hi NonText ctermfg=17 ctermbg=17 cterm=NONE guifg=#252c31 guibg=#252c31 gui=NONE
